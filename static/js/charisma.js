$(document).ready(function () {
    ...
    //     }
    //     $('.accordion ul').css("background-color","");
    //     if(themeName != "cyborg" && themeName != "darkly" && themeName != "slate")
    //     {
    //         $('.accordion ul').css("background-color","#2c5a7d");
    ...
    if (cUrl.substr(cUrl.length - 1) == '#') {
      cUrl = cUrl.slice(0,-1);
        ...
        if ($($(this))[0].href == cUrl){
            ...
            // console.log(cur);
            var tth = $(this).parent().parent().parent().find('.hht');
            if($(this).parent().parent().parent().hasClass('accordion'))
            {
                
                tth.removeClass('fa-plus').addClass('fa-minus');
    ...
    $('.accordion > a').click(function (e) {
        ...
        if($('.main-menu li a i').hasClass('fa-minus'))
            {

                $('.main-menu .hht').removeClass('fa-minus').addClass('fa-plus');
            }
       
        if($('.accordion ul').is(':visible') && $ul.is(':hidden'))
        {
        ...
        if ($ul.is(':visible')){ 
            ...
            $(this).children('i').eq(1).removeClass('fa-minus').addClass('fa-plus');
            ...
            $(this).children('i').eq(1).removeClass('fa-plus').addClass('fa-minus');
